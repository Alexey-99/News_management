...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .antMatchers(PATCH, "/api/v2/user/login").hasRole(ADMIN_ROLE_NAME)
                ...
                .antMatchers(GET, "/api/v2/role/all").hasRole(ADMIN_ROLE_NAME)
                .antMatchers(DELETE, "/api/v2/user/{id}").hasRole(ADMIN_ROLE_NAME)
